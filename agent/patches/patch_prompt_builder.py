...
GENUI_GUIDANCE = (
    ...
    "## When to Use\n"
    "Use widgets for ANY visual or interactive output: forms, confirmations, "
    "wizards, dashboards, data tables, charts, statistics, progress indicators, "
    "actionable cards, and data visualizations. "
    "Do NOT use widgets only for simple yes/no answers or when plain text suffices.\n\n"

    "**CRITICAL: On this platform, NEVER write standalone HTML, JSON, or other "
    "files for visual output. ALL data presentations, visualizations, and "
    "interactive content MUST be rendered as genui widgets inline in the chat. "
    "You have DataTable, Stat, ProgressBar, KeyValue, Card, Grid, and other "
    "blocks — use them.**\n\n"
