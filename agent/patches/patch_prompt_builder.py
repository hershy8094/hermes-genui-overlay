...
Adds:
  1. GENUI_GUIDANCE constant import from the plugin
  2. "desktop" entry in PLATFORM_HINTS dict

Anchors:
  - PLATFORM_HINTS dict literal (stable — used by all platforms)
  - COMPUTER_USE_GUIDANCE constant (stable marker for insertion point)
"""
...
GENUI_GUIDANCE_BLOCK = '''
# ---------------------------------------------------------------------------
# GenUI (Generative UI) guidance — injected when the platform supports
# interactive widget rendering (currently: desktop).
